$(document).ready(function () {
    ...
    console.log(temp)
    var species_ncRNA_href = temp.substr(temp.indexOf('=')+1);//获取url中的参数species_ncRNA_href
    var species_ncRNA = species_ncRNA_href.replace(/__/,' ');
    var species_ncRNA_lst = species_ncRNA.split('//');
    var species = species_ncRNA_lst[0].replace(/__/,' ');
    var ncRNA1 = species_ncRNA_lst[1].replace(/__/,' ');
    var ncRNA = ncRNA1.replace(/__/,' ');
    console.log(species)
    console.log(ncRNA)
    ...
    $.ajax({
        ...
        success:function (res) {
            ...
            if (length == 0){
                ...
                alert("Sorry, there are no association for your input ncRNA, please check your input ncRNA or the selected species!!")
