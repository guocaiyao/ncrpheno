$(document).ready(function () {
    (function () {
        ...
        var SelectType = tempurl[2].replace(reg, " ");
        ...
        $.ajax({
            ...
            success:function (res) {
                ...
                if (length == 0){
                    ...
                    // var html_str_info = "<tr><th>Disease_Name</th><td>Ontology_ID</td><td>Definition</td><td>Alternative_Name</td><td>Cross_Reference</td></tr>";
                    // html_str_info+= "<tr><th>"+ res_json.Results[0].Disease_Name+"</th><td>"+ res_json.Results[0].Ontology_ID+"</td><td>"+res_json.Results[0].Definition+"</td><td>"+res_json.Results[0].AlternativeName+"</td><td>"+res_json.Results[0].Cross_Reference+"</td></tr>";
                    ...
                    //         toDisplay += ", ";
                    //     }
                    //     toDisplay += '[' + res_json.Results[i].ncRNA_Symbol + ', ' + res_json.Results[i].Score + ', ' + res_json.Results[i].ncRPheDB_ID + ']';
                    // }
                    // toDisplay += "]";
                    ...
                    if(length<=210){
                        $('#canvas-container').css('height', '700px');
                        console.log("lengthss:" + length);
                    }else{
                        $('#canvas-container').css('height', '1200px');
                        console.log("lengthss:" + length);
                    }
