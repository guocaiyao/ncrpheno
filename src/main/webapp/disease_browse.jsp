...
<script type="text/javascript">
    $('#toWordle').click(function () {
        ...
        var disease = tempt.rows[1].cells[4].innerHTML;
        var input_dis = disease.split('(<')[0]
        window.open('myWordCloud_browse.html?'+input_dis,'_blank');
    })
</script>
...
<script src="static/js/disease_browse.js" type="text/javascript"></script>
</html>
